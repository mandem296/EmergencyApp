...
public class HospitalLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAuthListener=new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    ...
                    //Remember to change the activity where someone is directed to
                    Intent intent=new Intent(HospitalLoginActivity.this,Dashboard.class);
        ...
        //Register
        mEmail=(EditText) findViewById(R.id.hemail);
        mPassword=(EditText) findViewById(R.id.hpass);

        //Button
        mLogin=(Button) findViewById(R.id.hlogin);
        mRegister=(Button) findViewById(R.id.hregister);
                ...
                mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(HospitalLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful()){
                            ...
                            DatabaseReference current_user_db= FirebaseDatabase.getInstance().getReference().child("Users").child("Hospital").child(user_id);
